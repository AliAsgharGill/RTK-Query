...
const AddEdit = () => {
    ...
    // const [editMode, setEditMode] = useNavigate<boolean>(false);
            ...
            <div className="min-w-lg  h-screen  flex justify-center items-center  ">
                <form onSubmit={handleSubmit} className="bg-slate-300 w-1/4 shadow-md rounded px-8 pt-6 pb-8 mb-4" >
                    ...
                    <div className="">
                        ...
                        <input onChange={handleChange} className="block w-full text-sm text-gray-700 p-1  border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="user_avatar" type="file" name="pic" />
